 ...
 * 
 */
public abstract class AbstractTimeProviderErrorStrategy implements
    TimeProviderErrorStrategy
{
   ...
   */
  public AbstractTimeProviderErrorStrategy(
      TimeProviderErrorStrategyDescription description )
  {
    super();
