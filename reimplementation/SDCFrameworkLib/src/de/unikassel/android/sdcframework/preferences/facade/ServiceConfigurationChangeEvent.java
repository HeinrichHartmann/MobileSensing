...
/**
 * Interface for the service configuration change event. <br/>
 * <br>
 * A service configuration change event is created by the
 * {@linkplain de.unikassel.android.sdcframework.preferences.ApplicationPreferenceManagerImpl}
 * in case of shared preference changes affecting the service configuration.
 * 
