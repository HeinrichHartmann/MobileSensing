 ...
 * 
 */
public class WLANConnectionStrategy
    extends AbstractConnectionStrategy
{
   ...
   */
  public WLANConnectionStrategy( ConnectivityWrapper connectivityWrapper,
      Class< ? > controlActivityClass )
  {
    super( connectivityWrapper, controlActivityClass );
  }
   ...
   * de.unikassel.android.sdcframework.transmission.facade.ProtocolStrategytegy)
   */
  @Override
  public boolean isConnectionAvailable( ProtocolStrategy protocolStrategy )
  {
    // we can use just WIFI connections
    return isConnectionAvailable( protocolStrategy.getContext(),
