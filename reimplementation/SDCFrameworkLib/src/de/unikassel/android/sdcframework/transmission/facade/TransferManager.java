...
/**
 * Interface for the transfer manager. <br/>
 * <br/>
 * The transmission manager does a cyclic transfer of stored samples to a
 * configured server.
 * 
...
public interface TransferManager
    extends WorkerThread, LifeCycleObject,
    UpdatableTransmissionComponent< TransmissionConfiguration >,
    SampleRateChangeResponder, ObservableEventSource< TransferEvent >
{
  
  /**
   * Does force an activation of the transfer service.
   *
   * @return true if activated, false if database is empty.
   */
