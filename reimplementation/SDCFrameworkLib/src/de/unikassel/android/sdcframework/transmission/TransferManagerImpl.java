    ...
    implements TransferManager, EventObserver< NetworkStateChangeEvent >
{
      ...
      Class< ? > controlActivityClass )
  {
    ...
    this.transferEventSource = new ObservableEventSourceImpl< TransferEvent >();
    ...
    this.forcedActivationAlarm =
        AlarmBuilder.createAlarm( this, applicationContext );
   ...
   */
  @Override
  public synchronized boolean forcedActivation()
  {
    // ignore if database is empty
    if ( getCurrentRecordCount() > 0L )
    {
      ...
      if ( uploadManager.uploadFile( currentArchiveName ) )
      {
        ...
        Logger.getInstance().info(
            ...
            "Successful file ("
                ...
                + ") transfer!" );
        transferEventSource.notify( new TransferEvent() );
        return true;
      }
    }
    catch ( InterruptedException e )
  ...
  {
    transferEventSource.notify( data );
  }
  ...
  {
    return transferEventSource.hasObservers();
  }
  ...
  public void registerEventObserver(
      EventObserver< ? extends TransferEvent > observer )
  {
    transferEventSource.registerEventObserver( observer );
  }
  ...
  public void unregisterEventObserver(
      EventObserver< ? extends TransferEvent > observer )
  {
    transferEventSource.unregisterEventObserver( observer );
  }
  ...
  {
    transferEventSource.removeAllObservers();
  }
}
