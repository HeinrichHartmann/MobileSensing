...
public final class SDCConfiguration implements SerializableData
{
   ...
   */
  @Element( name = "broadcastFrequency", required = false )
  private Long broadcastFrequency;
  
  /**
   * The flag for the sampling enabled state
   */
  @Element( name = "samlingEnabled", required = false )
   ...
   */
  @Element( name = "weeklySchedule", required = false )
   ...
   *          the isSamplingEnabled flag to set
   */
   ...
   * 
   * @return the isSamplingEnabled flag
   */
