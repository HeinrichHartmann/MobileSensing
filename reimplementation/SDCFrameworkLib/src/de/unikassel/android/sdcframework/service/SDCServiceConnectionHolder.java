    ...
    implements LifeCycleObject
{
      ...
      Class< ? > serviceClass )
  {
    ...
    this.serviceConnection = new ServiceConnection()
    {
      ...
      {
        setSdcService( ISDCService.Stub.asInterface( service ) );
        
        for ( ServiceConnectionEventReceiver receiver : listEventReceivers )
        {
          receiver.onConnectionEstablished( getSdcService() );
        }
      }
    };
  }
  ...
  public void onDestroy( Context applicationContext )
  {
    if ( serviceAvailable )
    {
      if ( getSdcService() != null )
      {
        for ( ServiceConnectionEventReceiver receiver : listEventReceivers )
        {
          receiver.onAboutToDisconnect( getSdcService() );
        }
      }
   ...
   * @param sdcService the sdcService to set
   */
  private final synchronized void setSdcService( ISDCService sdcService )
  {
   ...
   * @return the sdcService
   */
  private final synchronized ISDCService getSdcService()
  {
    return sdcService;
  }
}
