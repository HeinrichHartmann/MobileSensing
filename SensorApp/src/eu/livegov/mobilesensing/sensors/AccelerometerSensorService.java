...
public class AccelerometerSensorService extends SensorService {
	...
	public List<? extends SensorValue> pullData() {
		...
		List<AccelerometerSensorValue> values = new ArrayList<AccelerometerSensorValue>(queueSize);
		
		Iterator<AccelerometerSensorValue> iterator = accQueue.iterator();
		while(iterator.hasNext()){
			AccelerometerSensorValue iteratorValue = (AccelerometerSensorValue)iterator.next();
	...
	SensorEventListener Listener = new SensorEventListener() {
		...
		public void onSensorChanged(SensorEvent arg0) {
			...
			lastValue = new AccelerometerSensorValue(arg0.timestamp,arg0.values[0], arg0.values[1], arg0.values[2]);
