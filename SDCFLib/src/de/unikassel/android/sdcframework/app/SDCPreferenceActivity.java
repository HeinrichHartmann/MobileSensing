...
public final class SDCPreferenceActivity extends PreferenceActivity
{
   ...
   * 
   * @param root
   *          the root element to add preferences into
   */
   ...
   * 
   * @param root
   *          the root element to add service preferences into
   */
  private void createServicePreferences( PreferenceScreen root )
  {
    ...
    createSampleRelatedPreferences( servicePrefScreen, servicePrefs );
  ...
  /**
   * Does create the sample related preferences dynamically in the given root
   * screen
   * 
   * @param root
   *          the root element to add preferences to
   ...
   *          the service preference to create from
   */
  private void createSampleRelatedPreferences(
   ...
   * 
   * @param root
   *          the root element to add device preferences into
   */
