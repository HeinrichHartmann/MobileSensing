 ...
 * 
 */
public class TagDeviceScanner extends ContentProviderDeviceScanner
{
  /**
   * Constructor
   * 
  ...
  {
    super( resolver, TagProviderData.getInstance().getContentUri() );
  }
  ...
  {
    TextSampleData data = new TextSampleData();
    data.setText( cursor.getString( cursor.getColumnIndex( TagProviderData.TEXT ) ) );
    return data;
  }
}
