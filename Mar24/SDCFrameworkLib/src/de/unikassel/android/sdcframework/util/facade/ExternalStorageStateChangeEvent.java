 ...
 * 
 */
public interface ExternalStorageStateChangeEvent
    extends ObservableEvent
{
  /**
   * Test method if external storage is available for read access
   * 
   * @return true if available for read access
   */
  public abstract boolean isExternalStorageAvailableForRead();
  
  /**
   * Test method if external storage is available for write access
   * 
   * @return true if available for write access
   */
  public abstract boolean isExternalStorageAvailableForWrite();
}
