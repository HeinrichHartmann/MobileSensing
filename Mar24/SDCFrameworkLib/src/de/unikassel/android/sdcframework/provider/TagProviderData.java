    ...
    extends AbstractContentProviderData
{
   ...
   * The tags field
   */
  public static final String TEXT = "tags";
  
  /**
   * The singleton instance
   */
  private final static TagProviderData instance = new TagProviderData();
  ...
  public HashMap< String, String > getProjectionMap()
  {
    ...
    projectionMap.put( TagProviderData.TEXT, TagProviderData.TEXT );
