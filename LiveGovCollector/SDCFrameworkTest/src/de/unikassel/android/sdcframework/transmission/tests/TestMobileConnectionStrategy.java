 ...
 * 
 */
public class TestMobileConnectionStrategy extends AndroidTestCase
{
  /*
   * (non-Javadoc)
   * 
   ...
   */
  public final void testMobileConnectionStrategy()
  {
    ...
    try
    {
      new MobileConnectionStrategy( null, null );
    ...
    try
    {
      new MobileConnectionStrategy( connectivityWrapper, null );
  ...
  /**
   * Test method for
   * {@link de.unikassel.android.sdcframework.transmission.MobileConnectionStrategy#isConnectionAvailable(de.unikassel.android.sdcframework.transmission.facade.ProtocolStrategy)}
   * and
   * {@link de.unikassel.android.sdcframework.transmission.MobileConnectionStrategy#doWork(ProtocolStrategy)}
   * .
   */
  public final void testIsConnectionAvailableAndDoWork()
  {
    ...
    MobileConnectionStrategy strategy =
        new MobileConnectionStrategy( connectivityWrapper, null );
    ...
    connectivityWrapper.isHostReachable = false;
