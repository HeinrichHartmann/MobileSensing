...
/**
 * Implementation of an event observer for samples
 * 
 * @author Katy Hilgenberg
 * 
 */
public class SampleEventObserverForTest implements
    EventObserver< Sample >
{
  /**
   * The internal list to store observed events
   */
  public final List< Sample > observedEvents =
        new CopyOnWriteArrayList< Sample >();
