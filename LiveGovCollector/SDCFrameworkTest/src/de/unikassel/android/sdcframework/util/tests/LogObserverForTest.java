...
/**
 * Class implementing an event observer for log events. Does always store last
 * observed event.
 * 
 * @author Katy Hilgenberg
 * 
 */
public class LogObserverForTest implements EventObserver< LogEvent >
{
  /**
   * The list to store observed events
   */
  public final ArrayList< LogEvent > events = new ArrayList< LogEvent >();
  
  /*
   * (non-Javadoc)
   * 
   * @see de.unikassel.android.sdcframework.util.facade.EventObserver#onEvent(de
