...
/**
 * Test implementation of content provider data for test purpose.
 * 
 * @author Katy Hilgenberg
 *
 */
public class ContentProviderDataForTest
extends AbstractContentProviderData
{
  ...
  /* (non-Javadoc)
   * @see de.unikassel.android.sdcframework.provider.facade.ContentProviderData#getContentTypeName()
   */
  @Override
