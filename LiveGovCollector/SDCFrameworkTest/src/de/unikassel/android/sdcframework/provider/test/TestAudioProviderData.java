...
/**
 * Test for the audio provider data
 * 
 * @author Katy Hilgenberg
 * 
 */
public class TestAudioProviderData
    extends AndroidTestCase
{
  
  /**
   * Test method for
   * {@link de.unikassel.android.sdcframework.provider.AudioProviderData#getProjectionMap()}
   * .
   */
  public final void testGetProjectionMap()
  {
    ...
    assertEquals( "wrong timestamp entry in projection map",
        ...
        projectionMap.get( AudioProviderData.LOCATION ) );
  }
  
  /**
   * Test method for
   * {@link de.unikassel.android.sdcframework.provider.AudioProviderData#getContentTypeName()}
   * .
   */
  ...
  /**
   * Test method for
   * {@link de.unikassel.android.sdcframework.provider.AudioProviderData#getInstance()}
   * .
   */
  public final void testGetInstance()
  {
    ContentProviderData providerData = AudioProviderData.getInstance();
    assertEquals( "Unexpected content type name", "sndrecordloc",
