...
/**
 * Test for the twitter device type.
 * 
 * @author Katy Hilgenberg
 * 
 */
public class TestTwitterDevice extends AndroidTestCase
{
  ...
  /**
   * Test method for
   * {@link de.unikassel.android.sdcframework.devices.TwitterDevice#TwitterDevice(android.content.Context)}
   * .
   */
  public final void testAudioDevice()
  {
    TwitterDevice device = new TwitterDevice( getContext() );
    assertTrue( "expected that a twitter device is a virtual sensor device",
        device instanceof VirtualSensorDevice );
    assertEquals( "unexpected device identifier",
        SensorDeviceIdentifier.Twitter, device.getDeviceIdentifier() );
