...
import de.unikassel.android.sdcframework.devices.ContentProviderDeviceScanner;

/**
 * Test implementation of a content provider device scanner
 * 
 * @author Katy Hilgenerg
 * 
 */
public class ContentProviderDeviceScannerForTest
    extends ContentProviderDeviceScanner
{
   ...
   * @param contentURI
   *          the related content URI
   */
  public ContentProviderDeviceScannerForTest( ContentResolver resolver,
      Uri contentURI )
  {
    super( resolver, contentURI );
  }
