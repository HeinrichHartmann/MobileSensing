...
/**
 * Tests for the GPS samples.
 * 
 * @author Katy Hilgenberg
 * 
 */
public class TestGPSSampleData extends TestCase
{
  
  /**
   * Test method for construction, setter and getter.
   */
  public final void testGPSSampleData()
  {
    ...
    assertEquals( "Expected equal sample", sampleData, new GPSSampleData( sampleData ) );    
  }
  ...
  { 
    ...
    GPSSampleData sampleData = createInitializedGPSSampleData();
    ...
    assertEquals( "Expected object equal to a copy construced instance",
        sampleData, new GPSSampleData( sampleData ) );
    
    assertFalse( "Expected object not equal to an uninitialized sample",
        sampleData.equals( new GPSSampleData() ) );
  }
  ...
  { 
    ...
    GPSSampleData gpsSampleData = createInitializedGPSSampleData();
    ...
    try
    {
      ...
      // serialize to object
      sampleData = GlobalSerializer.fromXML( GPSSampleData.class, sResult );
    }
    catch ( Exception e )
    {
      e.printStackTrace();
  ...
  /**
   * Does create an initialized GPS sample
   * 
   * @return an initialized GPS sample
   */
  public static GPSSampleData createInitializedGPSSampleData()
  {
    GPSSampleData sample = new GPSSampleData();
