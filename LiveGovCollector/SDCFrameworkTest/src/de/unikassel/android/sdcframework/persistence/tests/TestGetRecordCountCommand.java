...
/**
 * Tests for the get record count database command
 * 
 * @author Katy Hilgenberg
 * 
 */
public class TestGetRecordCountCommand extends AndroidTestCase
{
   ...
   */
  public final void testGetRecordCountCommand()
  {
    GetRecordCountCommand command = new GetRecordCountCommand();
  ...
  public final void testExecution()
  {
    ...
    // insert some samples into the database to test record count get command
    ...
    assertEquals( "Unexpected record count", Long.valueOf( sc.size() ), command.getResult() );    
  }
