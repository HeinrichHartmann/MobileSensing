...
public class ConnectionStrategyBuilder
{
   ...
   */
  public static ConnectionStrategy
      buildStrategy(
          ...
          Class< ? > controlActivityClass )
  {
    ...
    ConnectivityWrapper connectivityWrapper =
        ConnectivityWrapperImpl.getInstance();
    ConnectionStrategy strategy =
        new UseAvailableConnectionStrategy( connectivityWrapper,
    ...
    switch ( config.getTransmissionStrategy() )
    {
      ...
      {
        strategy =
            new WLANConnectionStrategy( connectivityWrapper,
                controlActivityClass );
        break;
      }
      ...
      {
        strategy =
            new MobileConnectionStrategy( connectivityWrapper,
                controlActivityClass );
        break;
      }
      case wlan_else_mobile:
      {
        strategy =
            new WLANConnectionStrategy( connectivityWrapper,
                controlActivityClass );
        strategy.setSuccessor( new MobileConnectionStrategy(
            connectivityWrapper, controlActivityClass ) );
        break;
      }
    }
    return strategy;
