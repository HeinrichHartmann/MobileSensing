 ...
 * 
 * @param <T>
 *          the configuration type to update from
 * 
 */
public interface UpdatableConfiguration< T extends Configuration > extends Configuration
{
  /**
   ...
   */
  public abstract void update( T configuration );
}
